    ...
    partial class MainForm
    {
        ...
        void WorkerMethod(object workerParam)
        {
            ...
            try
            {
                ...
                this._backend.OnAnnounceOperation
                    += new Action<string>(_backend_OnAnnounceOperation);
                this._backend.OnMessage
                    += new EventHandler<Backend.OnMessageEventArgs>(
                    this._backendInstance_OnMessage);
                this._backend.OnSourceDetected
                    += new Action<string>(_backend_OnSourceDetected);
                this._backend.OnCurrentProgressUpdate
                    += new Backend.ProgressEventDelegate(
                    this._backend_OnCurrentProgressUpdate);
                this._backend.OnGlobalProgressUpdate
                    += new Backend.ProgressEventDelegate(
                    this._backend_OnGlobalProgressUpdate);
                this._backend.OnEnterCriticalOperation
                    += new Backend.CriticalOperationEventDelegate(
                    delegate() { this._workerInCriticalOperation = true; });
                this._backend.OnExitCriticalOperation
                    += new Backend.CriticalOperationEventDelegate(
        ...
        void _backendInstance_OnMessage(object sender, Backend.OnMessageEventArgs e)
        {
